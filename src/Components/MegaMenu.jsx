...
//   return (
//     <div className="relative flex flex-row justify-between items-center m-auto w-[80%]">
//   <div className="w-28 h-28">
//     <img src={upanah_logo} className="w-28 h-28 xs:w-16 xs:h-16 lg:w-28 lg:h-28" alt="" />
//   </div>
//       <nav>
//         {/* Mobile Menu Button */}
...
//     <a href="#" className="text-black font-semibold text-xl">
//       Shop
//     </a>
//   </li>
...
//     </button>
//     {isAccountMenuOpen && (
//       <div className="absolute left-0 mt-2 md:mt-4 bg-white shadow-lg w-48 z-10">
//         <ul className="py-2">
//           <li>
//             <a
//               href="#"
